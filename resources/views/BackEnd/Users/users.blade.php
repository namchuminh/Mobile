        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                            ...
                            <table class="main__table">
                                ...
                                <tbody>
                                    @foreach ($users as $value)
                                        <tr>
                                            <td>
                                                <div class="main__table-text">ND{{ $value->id }}</div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="main__table-btns">
                                                    @can('edit-user')
                                                    <a href="{{ route('taikhoan.edit',$value->id) }}" class="main__table-btn main__table-btn--edit">
                                                    ...
                                                    @endcan
                                                    @can('delete-user')
                                                    <a href="#modal-delete" onclick="ModalDel('{{ $value->id }}','{{ $value->name }}','{{ route('taikhoan.destroy',$value->id) }}')" class="main__table-btn main__table-btn--delete open-modal">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                            <path
                    ...
                    <!-- paginator -->
                    <div class="col-12">
                        {!! $users->render('BackEnd.inc.paginator') !!}
                    </div>
                </div>
                <!-- end paginator -->
            </div>
